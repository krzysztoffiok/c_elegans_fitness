...
class MaskRCNN():
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        """
        import h5py
        from keras.engine import saving  #było topology
        ...
        if by_name:
            saving.load_weights_from_hdf5_group_by_name(f, layers) # było topology
        else:
            saving.load_weights_from_hdf5_group(f, layers) # było topology zamiast saving.
        if hasattr(f, 'close'):
            f.close()
