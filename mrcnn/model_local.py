...
class MaskRCNN():
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        """
        import h5py
        from keras.engine import topology  #było topology
        ...
        if by_name:
            topology.load_weights_from_hdf5_group_by_name(f, layers) # było topology
        else:
            topology.load_weights_from_hdf5_group(f, layers) # było topology zamiast saving.
        if hasattr(f, 'close'):
            f.close()
